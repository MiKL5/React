...
export default function Slider() {
  const [sliderIndex, setSliderIndex] = useState(1) // le state affiche la 1ère image en 1er
    ...
    <>
      ...
      <div className="slider">
        <p className="image-info">
          {sliderData.find(obj => obj.id === sliderIndex).description /* Objet dont l'id = sliderIndex */}
        </p>
        <img
